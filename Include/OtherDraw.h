...
void InputMM(){
    ...
    outtextxy(1355,300,(char*)"Resume");
    outtextxy(1355,350,(char*)"Records");
    outtextxy(1355,400,(char*)"Help & Support");
    outtextxy(1355,450,(char*)"Exit");
    ...
    while(true){
        ...
        switch(cur_op){
            ...
            case 3:setbkcolor(LIGHTBLUE);
                    ...
                    setbkcolor(FST_SCR_COLOR);
                    break;
            case 4: setbkcolor(LIGHTBLUE);
                    outtextxy(1355,450,(char*)"Exit");
                    setbkcolor(FST_SCR_COLOR);
                    break;
        }
        if(cur_op<0)cur_op=4;
        else if(cur_op==5)cur_op=0;
    }
}
...
void doMM(int op){
    ...
    case 0: drawInput();
            ...
            data.d1=player1.dice.color;
            data.d2=player2.dice.color;
            data.t1=player1.token.color;
            data.t2=player2.token.color;
            ActualDice();
            break;
    case 1: Resume();
            break;
...
void DisplayRecords(){
    ...
    if(file2==NULL){
        ...
        getch();
        setcolor(FST_SCR_COLOR);
        setfillstyle(SOLID_FILL,FST_SCR_COLOR);
        bar3d(400,90,910,650,5,1);
        setcolor(WHITE);
        settextjustify(2,1);
        settextstyle(8,0,5);
        return;
...
void Help(){
    ...
    settextstyle(4,0,3);
    settextjustify(1,2);
    outtextxy(650,120,(char*)"PLAYER1 KEYS");
    outtextxy(650,350,(char*)"PLAYER2 KEYS");
    settextstyle(8,0,3);
    outtextxy(650,590,(char*)"PLEASE TURN OFF CAPS-LOCK");
    settextjustify(0,2);
    outtextxy(420,180,(char*)"W | Throw Dice & Nav Up");
    outtextxy(420,220,(char*)"A | Confirm/YES");
    outtextxy(420,260,(char*)"S | Property Options & Nav Down");
    outtextxy(420,300,(char*)"D | Discard/NO");
    outtextxy(420,410,(char*)"O | Throw Dice & Nav Up");
    outtextxy(420,450,(char*)"K | Confirm/YES");
    outtextxy(420,490,(char*)"L | Property Options & Nav Down");
    outtextxy(420,530,(char*)"; | Discard/NO");
...
void drawInput(){
    ...
    for(;x<781;x+=680){
        ...
        for(i=0,j=x,choice_color=1,dt_num=1;i<400;i+=50,choice_color++,dt_num++){
            if(choice_color==3||choice_color==BROWN){++choice_color;}
            setcolor(BLACK);
